    ...
    <footer className="bg-gray-800 text-white p-8 mt-auto">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-gray-400">
            News Website Naufal is your go-to source for the latest news and
            trends from around the world. We provide accurate, unbiased, and
            comprehensive news coverage on a wide range of topics.
          </p>
        </div>
      ...
      <div className="border-t border-gray-700 mt-8 pt-4 text-center">
        ...
        <div className="text-center text-gray-400">
          ...
          <p>&copy; News Website Naufal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
